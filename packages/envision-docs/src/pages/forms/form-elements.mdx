...
The class `.env-form-control` creates a multipurpose container used to group and enhance form
controls and related elements.
...
Create an [input group](#input-group) with a label, input and button using a combination of
...
[Option elements](#option-elements), such as radio buttons, checkboxes and switches should use
the wrapper together with a label for alignment and spacing.

Use `.env-radio`, `.env-checkbox`, or `.env-switch` together with `.env-form-label`.
...
<span id="contenteditable" className="offset-anchor"></span>
...
<span id="select-component" className="offset-anchor"></span>
...
<div className={'doc-code-example'}>
   <div className="env-form-field">
      <label for="select-2" className="env-form-label">
...
<div className={'doc-code-example'}>
   <div className="env-form-field">
      <label for="select-3" className="env-form-label">
         <>Select element</>
      </label>
      <select className="env-form-input" id="select-3">
         <option>Item</option>
         <option>Item 2</option>
         <option>Item 3</option>
         <option>Item 4</option>
   ...
   <div class="env-form-field">
      <label for="select-4" className="env-form-label">
         <>Customizable select element</>
      </label>
      <select className="env-form-input" id="select-4">
         <button>
            <selectedcontent></selectedcontent>
         </button>
         <option>Item</option>
   ...
   <div class="env-form-field">
      <label for="multiple-select-1" className="env-form-label">
         <>Multiple select</>
      </label>
      <select className="env-form-input" id="multiple-select-1" multiple>
         <option>Item</option>
         <option>Item 2</option>
         <option>Item 3</option>
         <option>Item 4</option>
...
<div class="env-form-field">
   <label for="select-4" class="env-form-label"
      >Customizable select element</label
   >
   <select class="env-form-input" id="select-4">
      <button>
         <selectedcontent></selectedcontent>
      </button>
      <option>Item</option>
...
## Range input element <span class="doc-badge doc-badge--info">2026.05.1</span>

Use an input element with class `.env-range` and `[type="range"]`.

For the deprecated two-handle component, see [Range slider](/deprecated/range-slider/).

```html
<div class="env-form-field">
   <label for="range-1" class="env-form-label">Range input</label>
   <input class="env-range" type="range" id="range-1" />
</div>
```

To display step markers below the input, add a `datalist` element and connect it to the input
with the `list` attribute. The `datalist` must contain `option` elements with a `value` attribute.

```html
<div class="env-form-field">
   <label for="range-2" class="env-form-label">Range with markers</label>
   <input
      class="env-range"
      type="range"
      id="range-2"
      ...
      max="250"
      step="50"
      list="range-2-markers"
   />
</div>
<datalist id="range-2-markers">
