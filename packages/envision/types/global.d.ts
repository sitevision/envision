...
export type { AccordionInstance, CollapseInstance, DialogConfig, DialogInstance, ImageViewer2Config, ImageViewer2Instance, PopoverConfig, PopoverInstance, RangeSliderConfig, RangeSliderInstance, SelectConfig, SelectInstance, TabsConfig, TabsInstance, TooltipConfig, TooltipInstance, };
declare global {
    const envision: {
        /**
         ...
         */
        accordion(selector: string | HTMLElement | NodeList): Promise<AccordionInstance[] | undefined>;
        /**
         * Initialize a Collapse component
         * @param selector - CSS selector, DOM node, or node list
         */
        collapse(selector: string | HTMLElement | NodeList): Promise<CollapseInstance[] | undefined>;
        /**
         * Initialize a Dialog component
         * @param element - DOM element (HTMLDialogElement)
         * @param config - Configuration options
         */
        dialog(element: HTMLDialogElement, config?: DialogConfig): Promise<DialogInstance[] | undefined>;
        /**
         * Initialize an Image Viewer 2 component
         * @param selector - CSS selector, DOM node, or node list
         * @param config - Configuration options
         */
        imageViewer2(selector: string | HTMLElement | NodeList, config?: ImageViewer2Config): Promise<ImageViewer2Instance[] | undefined>;
        /**
         * Initialize a Popover component
         * @param selector - CSS selector, DOM node, or node list
         * @param config - Configuration options
         */
        popover(selector: string | HTMLElement | NodeList, config?: PopoverConfig): Promise<PopoverInstance[] | undefined>;
        /**
         * Initialize a Range Slider component
         * @param selector - CSS selector, DOM node, or node list
         * @param config - Configuration options
         */
        rangeSlider(selector: string | HTMLElement | NodeList, config?: RangeSliderConfig): Promise<RangeSliderInstance[] | undefined>;
        /**
         * Initialize a Tag Select component
         * @param selector - CSS selector, DOM node, or node list
         * @param config - Configuration options
         */
        select(selector: string | HTMLElement | NodeList, config?: SelectConfig): Promise<SelectInstance[] | undefined>;
        /**
         * Initialize a Tabs component
         * @param selector - CSS selector, DOM node, or node list
         * @param config - Configuration options
         */
        tabs(selector: string | HTMLElement | NodeList, config?: TabsConfig): Promise<TabsInstance[] | undefined>;
        /**
         ...
         * @param config - Configuration options
         */
        tooltip(selector?: string | HTMLElement | NodeList, config?: TooltipConfig): Promise<TooltipInstance[] | undefined>;
    };
}
