declare function _default(elements: string | HTMLElement | NodeList, options?: SelectConfig): Promise<SelectInstance[] | undefined>;
export default _default;
export type SelectOption = {
    value: string;
    text: string;
};
export type SelectRenderFunctions = {
...
export type SelectConfig = {
    ...
    onClear?: () => void;
    /**
     * - Invoked when a new option is added
     */
    onOptionAdd?: (value: string, data: SelectOption) => void;
    /**
     * - Invoked when an option is removed
     */
    onOptionRemove?: (value: string) => void;
    /**
     * - Invoked when all options are removed
     */
    onOptionClear?: () => void;
    /**
